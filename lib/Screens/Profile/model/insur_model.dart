class InsursModel {
  ...
  List<InsurModel>? get content => _content;
  set content(List<InsurModel>? content) => _content = content;
  ...
  InsursModel.fromJson(Map<String, dynamic> json) {
    if (json['content'] != null) {
      _content = <InsurModel>[];
      json['content'].forEach((v) {
        _content!.add(new InsurModel.fromJson(v));
      });
    }
...
class InsurModel {
  ...
  InsurModel.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
